...
$(window).scroll(function(){
	...
	$('.hasAnim2').each(function(){
		...
		if(isScrolledIntoView($(this), bDel) && hasPlayed.indexOf($(this).attr('id')) == -1){
			hasPlayed.push($(this).attr('id'));
			TweenMax.to($('#frame10').find('.sign'), 1, {delay:0, startAt:{'transform':'translate3d(0px, '+botX+'px, 0px)', 'visibility':'visible'}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})	
		}
	})
...
function goAnim(sec){
	...
	if(sec == 'frame2'){
		botY = $('#frame2').height() + $('#frame2').find('.lift>div').height();
		TweenMax.to($('#frame2').find('.lift'), 1, {startAt:{'transform':'translate3d(0px, '+botY+'px, 0px)', 'visibility':'visible'}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})				
	...
	if(sec == 'frame3'){
		botY = $('#frame3').height() + $('#frame3').find('.dash>div').height();
		TweenMax.to($('#frame3').find('.dash'), 1, {startAt:{'transform':'translate3d(0px, '+botY+'px, 0px)', 'visibility':'visible'}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})				
	...
	if(sec == 'frame4'){
		botY = $('#frame4').height() + $('#frame4').find('.store>div').height();
		TweenMax.to($('#frame4').find('.store'), 1, {startAt:{'transform':'translate3d(0px, '+botY+'px, 0px)', 'visibility':'visible', opacity:1}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})				
		
		leftX = -$('#frame4').find('.car').width();
		TweenMax.to($('#frame4').find('.car'), 1, {delay: .35, startAt:{'transform':'translate3d('+leftX+'px, 0px, 0px)', 'visibility':'visible'}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})				
		...
		TweenMax.to($('#frame4').find('.txtline'), 1, {delay:.85, startAt:{'transform':'translate3d(-100px, 0px, 0px)'}, 'transform':'translate3d(0px, 0px, 0px)', opacity:1, ease:Expo.easeOut})
	}
	
	if(sec == 'frame5'){
		leftX = -$('#frame5').find('.head>div').width();
		TweenMax.to($('#frame5').find('.head'), 1, {startAt:{'transform':'translate3d('+leftX+'px, 0px, 0px)', 'visibility':'visible'}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})				
	...
	if(sec == 'frame6'){
		topY = -$('#frame6').find('.car>div').height();
		TweenMax.to($('#frame6').find('.car'), 1, {startAt:{'transform':'translate3d(0px, '+topY+'px, 0px)', 'visibility':'visible'}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})				
	...
	if(sec == 'frame7'){
		leftX = -$('#frame7').find('.car>div').width();
		TweenMax.to($('#frame7').find('.car'), 1, {startAt:{'transform':'translate3d('+leftX+'px, 0px, 0px)', 'visibility':'visible'}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})				
	...
	if(sec == 'frame8'){
		topY = -$('#frame8').find('.burst>div').height();
		TweenMax.to($('#frame8').find('.burst'), 1, {startAt:{'transform':'translate3d(0px, '+topY+'px, 0px)', 'visibility':'visible'}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})				
		
		TweenMax.to($('#frame8').find('.txt'), 1, {delay:.5, startAt:{'transform':'translate3d(-100px, 0px, 0px)'}, 'transform':'translate3d(0px, 0px, 0px)', opacity:1, ease:Expo.easeOut})
		TweenMax.to($('#frame8').find('.txtline'), 1, {delay:.65, startAt:{'transform':'translate3d(-100px, 0px, 0px)'}, 'transform':'translate3d(0px, 0px, 0px)', opacity:1, ease:Expo.easeOut})
	}
	
	if(sec == 'frame9'){
		leftX = -$('#frame9').find('.wrench>div').width();
		TweenMax.to($('#frame9').find('.wrench'), 1, {startAt:{'transform':'translate3d('+leftX+'px, 0px, 0px)', 'visibility':'visible'}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})				
		
		TweenMax.to($('#frame9').find('.txt'), 1, {delay:.5, startAt:{'transform':'translate3d(100px, 0px, 0px)'}, 'transform':'translate3d(0px, 0px, 0px)', opacity:1, ease:Expo.easeOut})
		TweenMax.to($('#frame9').find('.txtline'), 1, {delay:.65, startAt:{'transform':'translate3d(100px, 0px, 0px)'}, 'transform':'translate3d(0px, 0px, 0px)', opacity:1, ease:Expo.easeOut})
	}
/*	
	if(sec == 'frame3'){
		topY = -900;
...
*/	
	if(sec == 'frame10'){
		botX = $('#frame10').height() + $('#frame10').find('.sign').height();
		TweenMax.to($('#frame10').find('.txt.top'), .5, {delay:.5, opacity:1})
		TweenMax.to($('#frame10').find('.cta-btn'), 1, {delay:.75, startAt:{scaleX:.5, scaleY:.5}, scaleX:1, scaleY:1, opacity:1, ease:Elastic.easeOut, easeParams:[2,2]})
		TweenMax.to($('#frame10').find('.txt.bot'), .5, {delay:.95, opacity:1})
	}
}
...
$('#frame10').find('.cta-btn').mouseenter(function(){
	TweenMax.to($(this), .5, {scaleX:1.1, scaleY:1.1, ease:Expo.easeOut})
})
$('#frame10').find('.cta-btn').mouseleave(function(){
