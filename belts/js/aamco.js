...
function goAnim(sec){
	...
	if(sec == 'frame2'){
		botX = $('#frame2').height() + $('#frame2').find('.belt>div').height();
		TweenMax.to($('#frame2').find('.belt>div'), 1, {startAt:{'transform':'translate3d(0px, '+botX+'px, 0px)', 'visibility':'visible'}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})				
	...
	if(sec == 'frame3'){
		botX = $('#frame3').height() + $('#frame3').find('.engine>div').height();
		TweenMax.to($('#frame3').find('.engine>div'), 1, {startAt:{'transform':'translate3d(0px, '+botX+'px, 0px)', 'visibility':'visible'}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})				
	...
	if(sec == 'frame4'){	
		topX = -$('#frame4').find('.warning').height();
		if(winW<768){topX = -1600;}
		TweenMax.to($('#frame4').find('.warning>div'), 1, {startAt:{'transform':'translate3d(0px, '+topX+'px, 0px)', 'visibility':'visible'}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})				
		TweenMax.to($('#frame4').find('.lines'), .5, {delay:.75, opacity:1})
		$('#frame4').find('.lines>div').addClass('blink2');

		TweenMax.to($('#frame4').find('.txt'), 1, {delay:1, startAt:{'transform':'translate3d(-100px, 0px, 0px)'}, 'transform':'translate3d(0px, 0px, 0px)', opacity:1, ease:Expo.easeOut})
		TweenMax.to($('#frame4').find('.txtline'), 1, {delay:1.2, startAt:{'transform':'translate3d(-100px, 0px, 0px)'}, 'transform':'translate3d(0px, 0px, 0px)', opacity:1, ease:Expo.easeOut})
	}
	
	if(sec == 'frame5'){
		botX = $('#frame5').height() + $('#frame5').find('.dash>div').height();
		TweenMax.to($('#frame5').find('.dash>div'), 1, {startAt:{'transform':'translate3d(0px, '+botX+'px, 0px)', 'visibility':'visible'}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})				
	...
	if(sec == 'frame6'){
		botX = $('#frame6').height() + $('#frame6').find('.car>div').height();
		TweenMax.to($('#frame6').find('.car>div'), 1, {startAt:{'transform':'translate3d(0px, '+botX+'px, 0px)', 'visibility':'visible'}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})				
		
		TweenMax.to($('#frame6').find('.bolts'), .5, {delay:.75, opacity:1})
		$('#frame6').find('.bolts>div').addClass('blink');
	...
	if(sec == 'frame7'){
		botX = $('#frame7').height() + $('#frame7').find('.ignition-wrap>div').height();
		TweenMax.to($('#frame7').find('.ignition-wrap>div'), 1, {startAt:{'transform':'translate3d(0px, '+botX+'px, 0px)', 'visibility':'visible'}, 'transform':'translate3d(0px, 0px, 0px)', ease:Expo.easeOut})				

		TweenMax.to($('#frame7').find('.num'), 1, {delay:1, startAt:{scaleX:.5, scaleY:.5}, scaleX:1, scaleY:1, opacity:1, ease:Elastic.easeOut, easeParams:[2,2]})
		TweenMax.to($('#frame7').find('.txt h2'), 1, {delay:1.25, startAt:{'transform':'translate3d(-100px, 0px, 0px)'}, 'transform':'translate3d(0px, 0px, 0px)', opacity:1, ease:Expo.easeOut})
		TweenMax.to($('#frame7').find('.txtline'), 1, {delay:1.5, startAt:{'transform':'translate3d(-100px, 0px, 0px)'}, 'transform':'translate3d(0px, 0px, 0px)', opacity:1, ease:Expo.easeOut})
